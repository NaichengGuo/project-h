...
class WinrateBaseAgent(BaseAgent):
    ...
    def calc_win_rate(self, hands, public_cards,n_players=2):
        ...
        # In case n_players is passed incorrectly or needs adjustment
        # calculate_equity expects total number of players
        winrate,tierate=self.win_rate_cal.calculate_equity(hands,public_cards,n_players)
        print(f"DEBUG: calc_win_rate hands={hands}, public={public_cards}, n_players={n_players} -> winrate={winrate}, tie={tierate}")
