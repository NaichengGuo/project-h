...
def wrap_state(state):
    ...
    wrapped_state["legal_actions"] = {k: None for k in legal_actions}
...
def reorganize_pettingzoo(trajectories):
    ...
    Args:
        trajectories (dict): A list of trajectories

    Returns:
        (dict): A new trajectories that can be fed into RL algorithms.
