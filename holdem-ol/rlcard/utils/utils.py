...
def is_red_suited(suit):
    if suit == 'H' or suit == 'D' or suit == 'h' or suit == 'd':
        return True
    return False
...
def print_card(cards):
    ...
    for card in cards:
        if card is None:
            ...
            lines[2].append('│         │')
            # red
            if raw_suit == 'H' or raw_suit == 'h':
                lines[3].append('\033[91m│    {}    │\033[0m'.format(suit))
            elif raw_suit == 'D' or raw_suit == 'd':
                lines[3].append('\033[95m│    {}    │\033[0m'.format(suit))
            elif raw_suit == 'C' or raw_suit == 'c':
                lines[3].append('\033[92m│    {}    │\033[0m'.format(suit))
            else:
